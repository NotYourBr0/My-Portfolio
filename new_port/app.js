...
const portfolioData = {
  personal: {
    ...
    description:
      "Highly motivated Computer Science undergraduate passionate about developing scalable web applications and AI-powered solutions. Quick learner, strong problem-solving skills, and experienced in MERN stack development.",
  },
  skills: [
    {
      name: "HTML5",
  ...
  projects: [
    ...
    },
    {
      ...
      technologies: ["React", "Node.js", "Express", "PDFKit", "Multer"],
      github_url: "https://github.com/NotYourBr0/Free_Images_To_PDF",
      live_url: "https://imgs2pdf.vercel.app/",
      featured: true,
    },

    {
      ...
      description:
        "A pixel-perfect Myntra frontend clone with React, Vite, Tailwind CSS & Framer Motion. Features dynamic product listings, category navigation, and smooth animations.",
      technologies: [
        "React",
        "Vite",
        "Framer Motion",
  ...
  document.addEventListener("click", function (e) {
    ...
    if (certificateMail) {
      ...
      const certificateTitle =
        certificateMail.querySelector(".certificate-title").textContent;
...
function initializeAnimations() {
  ...
  const animatedElements = document.querySelectorAll(
    ".hero-title, .hero-subtitle, .hero-description, .hero-actions"
  );
